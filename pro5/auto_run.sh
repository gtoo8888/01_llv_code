...
# 项目路径
PROJECT_DIR="/data_sdb/openclaw/KnowledgeWorkspace/02_llv_generated/01_llv_code/pro5"
PID_FILE="$PROJECT_DIR/app.pid"
LOG_FILE="$PROJECT_DIR/app.log"

# Python 解释器 (conda 环境)
PYTHON_BIN="$HOME/anaconda3/envs/llm_chat_dashboard/bin/python"
...
case $1 in
    ...
    clean) clean ;;
    *) echo "Usage: $0 {run|stop|status|logs|restart|clean}"; exit 1 ;;
esac
